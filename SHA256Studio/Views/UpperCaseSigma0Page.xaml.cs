...
{
    public sealed partial class UpperCaseSigma0Page : Page
    {
        MainPage MainPage { get; }

        uint x { get; set; }

        uint upperCaseSigma0 { get; set; }

        public UpperCaseSigma0Page()
        {
            InitializeComponent();
        ...
        private void InitiateUI()
        {
            ...
            upperCaseSigma0 = BitwiseOperations.UpperCaseSigma0(x);

            Bits32UpperCaseSigma0TextBlock.Text = Convert.ToString(upperCaseSigma0, 2).PadLeft(32, '0');
        }
